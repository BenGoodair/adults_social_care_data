...
#Task 1 = get all location IDs
conn.request('GET','/public/v1/locations?careHome=Y&perPage=10000&page=1', headers=headers)
...
conn.request('GET','/public/v1/locations?careHome=Y&perPage=10000&page=2', headers=headers)
res = conn.getresponse()
...
conn.request('GET','/public/v1/locations?careHome=Y&perPage=10000&page=3', headers=headers)
res = conn.getresponse()
...
conn.request('GET','/public/v1/locations?careHome=Y&perPage=10000&page=4', headers=headers)
res = conn.getresponse()
...
#save all carehomes
csv_file_path = "Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/care_homes_cqc_api_2025.csv"
    ...
    while True:
        try:
            ...
            if res.status == 200:
                ...
                print(f"API successful for locationId {location_id}. yayeee")
...
#save all carehomes
csv_file_path = "Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/all_carehomes_all_info_2025.csv"
...
#save all carehomes
csv_file_path = "Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/historic_ratings_only_2025.csv"
...
#save all carehomes
csv_file_path = "Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/all_ratings_2025.csv"
...
data = pd.read_csv("Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/all_carehomes_all_info_2025.csv")
...
#save all carehomes
csv_file_path = "Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/relationship_expanded.csv"
...
# Load the data
df = pd.read_csv("Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/all_carehomes_all_info_2025.csv")
...
def main():
    # Load the data
    print("Loading data...")
    file_path = "Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/all_carehomes_all_info_2025.csv"
    ...
    try:
        ...
        output_file = "Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/flattened_carehomes_assessments.csv"
...
all_ratings = pd.read_csv("Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/all_ratings_2025.csv")

all_assessments = pd.read_csv("Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/flattened_carehomes_assessments.csv")
...
#save all carehomes
csv_file_path = "Library/CloudStorage/OneDrive-Nexus365/Documents/Children's Care Homes Project/CQC_API_materials/Data/all_ratings_care_homes_2025_with_assessments.csv"
